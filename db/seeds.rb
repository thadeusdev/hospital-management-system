...
patients = [
    {full_name: "John Kilonzo", address: "Lavington 2nd Ave", visiting_date: DateTime.new(2009,9,1,17), visit_no: "GN-114730-21"},
    {full_name: "Musa Abdul", address: "Mathare Area", visiting_date: DateTime.new(2009,9,1,17), visit_no: "GN-114730-22"},
    {full_name: "Ezra Kipchumba", address: "Kasarani Area", visiting_date: DateTime.new(2009,9,1,17), visit_no: "GN-114730-23"},
    {full_name: "Wilson Owino", address: "Nairobi CBD", visiting_date: DateTime.new(2009,9,1,17), visit_no: "GN-114730-24"},
    {full_name: "James Njorio", address: "Pangani Area", visiting_date: DateTime.new(2009,9,1,17), visit_no: "GN-114730-25"}
]
